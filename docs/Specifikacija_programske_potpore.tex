	...
	\section{Funkcionalni zahtjevi}
		...
		\end{figure}
			\subsection{Sekvencijski dijagrami}
				...
				\begin{figure}[H]
			\includegraphics[scale=1.0]{slike/unosPrijave.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			\centering
		...
		\end{figure}
				...
				\begin{figure}[H]
			\includegraphics[scale=1.0]{slike/prijavaiReg.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			\centering
		...
		\end{figure}
				...
				\textbf{Obrazac uporabe UC05, UC06, UC11 - uređivanje podataka prijave, brisanje prijave, pregled korisnika}\\
				...
				\begin{figure}[H]
			\includegraphics[scale=1.0]{slike/upravljanje.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			\centering
		...
		\end{figure}
			...
			\begin{figure}[H]
			\includegraphics[scale=0.7]{slike/gradskisekv.PDF} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			\centering
