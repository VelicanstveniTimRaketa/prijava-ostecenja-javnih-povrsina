      ...
      <Card style={{ display: "flex", flexDirection: "row", flex: 0 }}>
        <div style={{ display: "flex", margin: "2em", gap: "2em" }}>
          <div style={{ display: "flex", alignItems: "center", width: "10em", height: "10em", flex: 0 }}>
            ...
            <Layout className="shadow" style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "10em", height: "10em", background: "#cecece", borderRadius: "100em" }}>
          ...
          <div style={{ flexDirection: "column" }}>
            ...
            <Button style={{ marginTop: "2em"}} icon={<EditOutlined />}>Izmijeni profil</Button>
          </div>
        </div>
      </Card>
    </Content>
