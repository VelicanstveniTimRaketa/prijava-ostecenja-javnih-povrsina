	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\noindent \underbar{\textbf{UC16 - Pregled dobivenih prijava}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC20 - Prihvaćanje zahtjeva ulaska u gradski ured}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC22 - Stvaranje novog gradskog ureda}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC24 - UC24- Praćanje prijave jedinstvenim ID-om}}
					\begin{packed_item}
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\begin{figure}[H]
			\includegraphics[scale=0.8]{slike/obrazac_nereg.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			\centering
