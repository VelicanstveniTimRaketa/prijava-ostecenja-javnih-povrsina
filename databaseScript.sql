...
(ostecenje_id,opis, lokacija_id, kreator_id, prvo_vrijeme_prijave, parent_prijava_id, vrijeme_otklona) values
                                                                                                           ...
                                                                                                           (2,'', 3, 1, current_timestamp, 1, null),
                                                                                                           (2,'', 2, 2, current_timestamp, null, null),
                                                                                                           (3,'', 6, 3, current_timestamp, 1, null),
                                                                                                           (2,'', 6, 2, current_timestamp - '10 hours' :: interval, null, current_timestamp),
                                                                                                           (2,'',2,4,current_timestamp - '1 day'::interval,2,null),
                                                                                                           (3,'', 7, 1, current_timestamp - '2 hours' :: interval, null, null),
                                                                                                           (4,'', 7, 2, current_timestamp - '5 hours' :: interval, 2, null),
                                                                                                           (4,'', 4, 3, current_timestamp - '12 hours' :: interval, null, current_timestamp),
                                                                                                           (3,'', 2, 4, current_timestamp - '3 days' :: interval, 1, null),
                                                                                                           (4,'', 4, 4, current_timestamp - '7 days' :: interval, null, current_timestamp - '1 day' :: interval),
                                                                                                           (3,'', 3, 1, current_timestamp - '10 days' :: interval, 2 , null);
